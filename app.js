...
function renderBookingForm(form, type) {
  ...
  form.innerHTML = `
    ...
    <label>Data <input name="date" type="date" min="${ALLOWED_DATES[0]}" max="${ALLOWED_DATES[ALLOWED_DATES.length - 1]}" required></label>
    <p class="form-hint full">Date disponibili: 24, 25, 26, 31 luglio; 1, 2 agosto; tutti i giorni dal 7 al 16 agosto 2026.</p>
