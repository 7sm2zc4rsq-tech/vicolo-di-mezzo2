...
function renderBookingList() {
  ...
  el.bookingList.innerHTML = `
    ${renderDayButtons("bookings", dates, groups, (dayBookings) => {
      ...
      return `${dayBookings.length} prenotazioni - ${people}/80 coperti`;
    })}
...
function renderBookingDay(date, dayBookings) {
  ...
  return `
    <section class="day-group">
      ...
      <p class="day-total">${dayBookings.length} prenotazioni - ${people}/80 coperti prenotati - ${freeSeats} disponibili</p>
...
function renderProductDay(date, dayBookings) {
  ...
  return `
    <section class="day-group">
      <h3>${formatLongDate(date)}</h3>
      <p class="day-total">${people}/80 coperti prenotati</p>
      ${menuItems.map((item) => `
